...
class SMPLXCamHead(nn.Module):
    ...
    def forward(self, rotmat, shape, cam, cam_intrinsics,
        ...
        mscn_coeff = psim.anchor_spherical_mscn_cal(joint1, joint2, joint3, joint4)
        print(f"mscn_coeff : {mscn_coeff}")
        #log 기록
        with open('mscn_log.txt', 'a') as file:
            new_coeff = mscn_coeff
            file.write(f'{new_coeff}\n')
